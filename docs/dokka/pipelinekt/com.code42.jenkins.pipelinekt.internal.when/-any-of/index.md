[pipelinekt](../../index.md) / [com.code42.jenkins.pipelinekt.internal.when](../index.md) / [AnyOf](./index.md)

# AnyOf

`data class AnyOf : `[`When`](../../com.code42.jenkins.pipelinekt.core/-when.md)
