...
fun DslContext<Step>.def(steps: DslContext<Step>.() -> Unit): Var.Variable = def(generateVariableName(), steps)
...
fun DslContext<Step>.def(value: Var): Var.Variable = def(generateVariableName(), value)
fun DslContext<Step>.def(variableName: String, value: Var): Var.Variable = def(variableName, { literal(value.toGroovy()) })
...
fun DslContext<Step>.assign(variable: Var.Variable, value: Var): Var.Variable = assign(variable, { literal(value.toGroovy()) })
